 ...
 */
int nnstreamer_query_receive (query_connection_handle connection, TensorQueryCommandData * data)
{
  //TensorQueryConnection *conn = (TensorQueryConnection *) connection;
...
//    //tid = pthread_create (&conn->msg_thread, &attr, _message_handler, thread_data);
